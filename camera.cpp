/**
 * @file camera.cpp
 * @brief Implementation of the Camera class for handling camera operations in OpenGL.
 *
 * This file contains the implementation of the Camera class defined in the corresponding header file.
 */
...
#include "camera.hpp"
  ...
  *
  * @param iPos The initial position of the camera.
  * @param iFront The initial front vector of the camera.
  * @param iUp The initial up vector of the camera.
  * @param iMovSpeed The movement speed of the camera.
  * @param iYaw The initial yaw angle of the camera.
  * @param iPitch The initial pitch angle of the camera.
  */
