/**
 * @file shader.cpp
 * @brief Implementation of the Shader class for handling OpenGL shader operations.
 *
 * This file contains the implementation of the Shader class defined in the corresponding header file.
 */
...
*/
    Shader::Shader(unsigned int idcp){
        this->ID = idcp;
    }
